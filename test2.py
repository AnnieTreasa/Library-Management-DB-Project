...
class LoginPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        user_id=StringVar()
        userEntry=Entry(self,width=25,font=('Microsoft Yehei UI Light',11,'bold'),bg='white',bd=0,fg='firebrick2',textvariable=user_id)
        ...
        password=StringVar()
        pwdEntry=Entry(self,width=25,font=('Microsoft Yehei UI Light',11,'bold'),bg='white',bd=0,fg='firebrick2',textvariable=password)
        ...
        loginButton =Button(self,text='Login',font=('Open Sans',16,'bold'),fg='white',bg='firebrick1',activebackground='firebrick1',activeforeground='white',cursor='hand2',bd=0,width=19,command= lambda: loginFN(user_id,password))
