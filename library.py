...
class LoginPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        heading = Label(self, text='USER LOGIN', font=(
            'Microsoft Yehei UI Light', 23, 'bold'), bg='white', fg='firebrick2')
        heading.place(x=605, y=120)

        userEntry = Entry(self, width=25, font=(
            'Microsoft Yehei UI Light', 11, 'bold'), bg='white', bd=0, fg='firebrick2')
        userEntry.place(x=580, y=200)
        userEntry.insert(0, 'Username')

        userEntry.bind('<FocusIn>', user_enter)

        frame1 = Frame(self, width=250, height=2,
                       bg='firebrick1').place(x=580, y=222)

        pwdEntry = Entry(self, width=25, font=(
            'Microsoft Yehei UI Light', 11, 'bold'), bg='white', bd=0, fg='firebrick2')
        pwdEntry.place(x=580, y=300)
        pwdEntry.insert(0, 'Password')
        pwdEntry.bind('<FocusIn>', pwd_enter)
        frame2 = Frame(self, width=250, height=2,
                       bg='firebrick1').place(x=580, y=322)

        openeye = PhotoImage(file='openeye.png')
        eyebutton = Button(self, image=openeye, bd=0, bg='white',
                           activebackground='white', cursor='hand2', command=hide)
        eyebutton.place(x=800, y=290)

        loginButton = Button(self, text='Login', font=('Open Sans', 16, 'bold'), fg='white', bg='firebrick1', activebackground='firebrick1',
                             activeforeground='white', cursor='hand2', bd=0, width=19, command=loginFN(userEntry.get(), pwdEntry.get()))
        loginButton.place(x=588, y=380)

        signupLabel = Label(self, text="Don't have an account?", font=(
            'Open Sans', 10), fg='firebrick1', bg='white')
...
class SignupPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def registerFN():
            try:
                ...
                adr = (useridEntry.get(), usernameEntry.get(), phnoEntry.get(
                ), pwdEntry.get(), deptEntry.get(), admyearEntry.get())
    ...
    # print(a)
        ...
        heading = Label(frame, text="CREATE AN ACCOUNT ", font=(
            'Microsoft Yehei UI Light', 18, 'bold'), bg='white', fg='firebrick2')
        heading.grid(row=0, column=0, padx=10, pady=10)

        # userid
        useridlabel = Label(frame, text="User Id : ", font=(
            'Microsoft Yehei UI Light', 10, 'bold'), bg='white', fg='firebrick2')
        useridlabel.grid(row=1, column=0, sticky='w', padx=25)

        useridEntry = Entry(frame, width=25, font=(
            'Microsoft Yehei UI Light', 10, 'bold'), bg='light pink', fg='DeepPink4')
        useridEntry.grid(row=2, column=0, sticky='w', padx=25)

        # username
        usernamelabel = Label(frame, text="User Name : ", font=(
            'Microsoft Yehei UI Light', 10, 'bold'), bg='white', fg='firebrick2')
        ...
        loginLabel = Label(self, text="Alredy have an account?", font=(
            'Open Sans', 10), fg='firebrick1', bg='white')
...
app = App()
app.mainloop()        
>>>>>>> 12be942865cfe17bef3f21de405a9b8f64d8766f
